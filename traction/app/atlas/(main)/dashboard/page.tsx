...
import { getInitials, getAvatarColor } from '@/lib/atlas-utils';
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      ...
      try {
        const res = await fetch(`/atlas/api/members?lat=${coords.latitude}&lng=${coords.longitude}&radius=50`);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm font-medium text-gray-500">Loading Atlas...</span>
        </div>
      </div>
    );
  }
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {isProfileIncomplete && (
                ...
                >
                  ...
                  <button 
                    onClick={() => router.push('/atlas/settings')}
              ...
              >
                <Link href="/atlas/discover" className="block group">
                  <div className="bg-gradient-to-br from-[#e62e3d] via-[#eb3a48] to-[#f43f5e] p-8 lg:p-12 text-white rounded-2xl shadow-md shadow-red-500/10 hover:shadow-lg hover:shadow-red-500/20 transition-all duration-300 relative overflow-hidden active:scale-[0.99] min-h-[220px] flex flex-col justify-between">
                    ...
                    <div className="relative z-10 flex items-end justify-between gap-4">
                      <div>
                        ...
                        <p className="text-white/80 font-medium text-sm mt-1.5">Connect with atlas business professionals</p>
                      </div>
            ...
            <div className="lg:col-span-4 space-y-6 lg:pt-16">
              ...
              >
                <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex items-center justify-between">
                  <div>
                    <p className="text-gray-400 text-xs font-semibold uppercase tracking-wider">Atlas Professionals</p>
          ...
          {members.length > 0 && (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/atlas/discover" className="text-sm font-bold text-[#e62e3d] hover:underline flex items-center gap-1">
              ...
              <div className="flex overflow-x-auto gap-4 pb-4 snap-x hide-scrollbar">
                ...
                {members.length > 8 && (
                  <Link href="/atlas/discover" className="snap-start shrink-0 w-[140px] bg-gray-50 rounded-2xl border border-dashed border-gray-300 p-4 flex flex-col items-center justify-center text-center hover:bg-gray-100 transition-colors cursor-pointer group">
