...
export default function AdminLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch('/atlas/api/auth/login', {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center font-sans p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mt-6">
          <button onClick={() => router.push('/atlas/login')} className="text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors">
