    ...
    <div className="min-h-screen bg-white flex flex-col font-sans overflow-hidden relative">
      ...
      <header className="w-full absolute top-0 left-0 right-0 z-50 pt-8">
        <div className="max-w-[1500px] mx-auto w-full px-4 sm:px-6 lg:px-12 xl:px-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link href="/nearby/login" className="inline-flex items-center justify-center px-4 py-2 sm:px-6 sm:py-2 bg-white text-gray-900 border border-gray-200 rounded-lg font-semibold text-[13px] sm:text-[15px] hover:bg-gray-50 hover:border-gray-300 transition-all duration-150 whitespace-nowrap shadow-sm">
              Log In
            </Link>
            <Link href="/nearby/signup" className="inline-flex items-center justify-center px-4 py-2 sm:px-6 sm:py-2 bg-[#e62e3d] text-white border border-[#e62e3d] rounded-lg font-semibold text-[13px] sm:text-[15px] hover:bg-[#d02432] hover:border-[#d02432] transition-all duration-150 whitespace-nowrap shadow-sm">
              Sign Up
            </Link>
          </div>
        </div>
      ...
      <main className="flex-1 max-w-[1500px] mx-auto w-full px-6 lg:px-12 xl:px-16 pt-32 lg:pt-28 pb-8 relative z-10 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-[45%]">
          ...
          >
            <Link href="/nearby/signup" className="inline-flex items-center justify-center px-7 py-3.5 bg-[#e62e3d] text-white border border-[#e62e3d] rounded-lg font-semibold text-[15px] hover:bg-[#d02432] hover:border-[#d02432] transition-all duration-150 whitespace-nowrap gap-2 shadow-sm">
              Get Started 
