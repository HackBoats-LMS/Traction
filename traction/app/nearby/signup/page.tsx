...
export default function SignupPage() {
  ...
  useEffect(() => {
    ...
    if (errorParam) {
      ...
      // Clean up the URL
      window.history.replaceState({}, '', '/nearby/signup');
    }
  }, []);
    ...
    <div className="min-h-screen bg-white flex font-sans overflow-hidden relative">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between p-6 sm:p-12 md:p-16 z-10 relative bg-white/80 backdrop-blur-sm min-h-screen">
        ...
        <div className="flex items-center justify-between">
          <Link href="/nearby" className="flex items-center gap-3">
        ...
        <div className="w-full max-w-[400px] mx-auto my-auto py-12">
          ...
          >
            ...
            <div className="text-center text-sm text-gray-500 mt-6">
              Already verified?{' '}
              <Link href="/nearby/login" className="text-[#e62e3d] font-bold hover:underline">Log in</Link>
            </div>
          </motion.div>
        </div>
        ...
        <div className="text-center lg:text-left text-sm text-gray-500 mt-8">
          Admin access?{' '}
          <Link href="/nearby/admin/login" className="text-[#e62e3d] font-bold hover:underline">Log in</Link>
        </div>
