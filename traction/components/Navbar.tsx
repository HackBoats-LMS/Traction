  ...
  return (
    <nav className="relative flex items-center justify-between px-6 md:px-10 py-4 w-full bg-[#F5F5F7]/80 backdrop-blur-md border-b border-black/5 z-50">
      ...
      <div className="hidden md:flex items-center">
        <button className="bg-[#A3E6B5] hover:bg-[#8fd9a3] text-black font-semibold px-6 py-2.5 rounded-lg transition-colors text-sm border border-[#A3E6B5] shadow-sm">
          Get Started
        </button>
      </div>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex flex-col px-6 py-6 gap-6">
              ...
              <button className="w-full bg-[#A3E6B5] hover:bg-[#8fd9a3] text-black font-bold px-6 py-3 mt-2 rounded-lg transition-colors text-base shadow-sm border border-[#A3E6B5]">
                Get Started
              </button>
            </div>
          </motion.div>
