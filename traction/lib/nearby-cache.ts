...
export const geocodingCache = new NearbyCache<any>(1000 * 60 * 60 * 24); // 24 hours for geocoding
export const membersCache = new NearbyCache<any>(1000 * 30); // 30 seconds for nearby members
